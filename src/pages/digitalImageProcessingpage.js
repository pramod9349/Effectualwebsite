...
class digitalImageProcessingpage extends Component {
    render() {
        return (
            <div>
                <Navigation />
            ...
            <main class="mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16  lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                <h1 class="px-20 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span class="block xl:inline">Digital Image                
                    <span class="block text-red-600 xl:inline"> Processing</span> </span> 
...
<br />
							  ...
							  <ul>
<li>Flaw-less understanding of the invention with the help of disclosure provided by the client or interviewing the client.</li>
<li>Defining the novelty based on the understanding and existing art.</li>
<li>Drafting the final set of claims in a broadest possible manner, keeping in mind the Indian laws.</li>
<li>Drafting complete specifications to capture all possible embodiments of the invention.</li>
</ul>
                            </div>
...
export default digitalImageProcessingpage;